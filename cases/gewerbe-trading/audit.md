...
- Маленький логотип **brend.png** (ROUTE/LINE) — на **передней
  стороне**, слева на груди **со стороны сердца носителя** (то есть
  визуально с точки зрения зрителя — справа). Точные параметры в
  редакторе Printify: Ширина 5", Высота 1,2", Масштаб ~48,65%, Поворот
  0°, Позиция сверху 0%, Позиция слева ~64,4% (не 0% — 0% визуально
  ставит лого на противоположную, неправильную сторону; исправлено
  2026-08-23 по замечанию владельца вживую)
